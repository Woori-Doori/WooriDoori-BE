...
public class QDiary extends EntityPathBase<Diary> {
    ...
    private static final long serialVersionUID = -1182823780L;
    ...
    public final DatePath<java.time.LocalDate> diaryDay = createDate("diaryDay", java.time.LocalDate.class);

    public final StringPath diaryEmotion = createString("diaryEmotion");
